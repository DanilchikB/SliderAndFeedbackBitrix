...
<head>
    ...
    //Подключение slick
    $APPLICATION->SetAdditionalCSS(SITE_TEMPLATE_PATH."/js/plugins/slick/slick.css");
    $APPLICATION->SetAdditionalCSS(SITE_TEMPLATE_PATH."/js/plugins/slick/slick-theme.css", true);
    $APPLICATION->AddHeadScript(SITE_TEMPLATE_PATH."/js/plugins/slick/slick.min.js");
